          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 lg:gap-5">
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="absolute -top-3 -left-3 w-7 h-7 rounded-full bg-background border-2 border-primary/50 flex items-center justify-center z-20 opacity-90">
                  <span className="text-sm font-bold gradient-text opacity-90">{index + 1}</span>
                </div>
